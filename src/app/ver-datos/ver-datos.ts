...
@Component({
  ...
  <!-- ERROR -->
  <div *ngIf="error" class="max-w-3xl mx-auto bg-red-50 border border-red-200 rounded-lg p-6 text-center">
  ...
  <div *ngIf="!cargando && !error && datos" class="max-w-3xl mx-auto">
    ...
    <div class="text-center mb-8">
      ...
      <img src="ddk.png" class="h-56 mx-auto">
    ...
    <div class="bg-white shadow-xl rounded-lg p-8 space-y-6">
      ...
      <input [value]="datos.nombre" disabled class="w-full px-4 py-3 border rounded-lg bg-gray-100">

      <input [value]="datos.apellido" disabled class="w-full px-4 py-3 border rounded-lg bg-gray-100">

      <input [value]="datos.telefono" disabled class="w-full px-4 py-3 border rounded-lg bg-gray-100">

      <input [value]="datos.email" disabled class="w-full px-4 py-3 border rounded-lg bg-gray-100">
